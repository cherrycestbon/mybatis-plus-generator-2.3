...
public class TestMP_PostgreSQL {
	/**
	 * 	代码生成示例代码
	 * 	更多配置见：
	...
	public void testGenerator() {
		...
		dsConfig
			.setDbType(DbType.POSTGRE_SQL)  // 设置数据库类型
			.setDriverName("org.postgresql.Driver")
			.setUrl("jdbc:postgresql://192.168.2.95:5432/train_9h")
		...
		stConfig.setCapitalMode(true) //全局大写命名
				...
				.setInclude("opera_train_trend_note");  // 利用代码生成器时使用的表
		//4.包名策略配置
		PackageConfig pkConfig = new PackageConfig();
		pkConfig.setParent("com.bettem.training.module.operaTrain.trend")
				.setMapper("dao")
				.setService("service")
